...
//     #[uniffi::constructor]
//     pub fn new(relay_urls: Vec<String>) -> Result<Arc<Self>, String> {
...
//         Ok(Arc::new(Self {
//             iroh_endpoint: res.map_err(|e| e.to_string())?,
...
//     pub fn connect(&self, addr: String) -> Result<(), String> {
//         let handle = self.runtime.handle();
//         let endpoint = self.iroh_endpoint.clone();
        
//         handle.block_on(async {
//             let addr_bytes = BASE64_STANDARD.decode(addr).map_err(|e| e.to_string())?;
//             let addr: EndpointAddr = bitcode::deserialize(&addr_bytes).map_err(|e| e.to_string())?;
...
//     pub fn get_local_endpoint_addr(&self) -> Result<String, String> {
...
//                 Ok(())
//             } else {
//                 Err("Cannot accept connection".to_string())
//             }
//         })
//     }

//     pub fn accept_bidi_stream(&self) -> Result<(), String> {
//         let handle = self.runtime.handle();
...
//                     Ok(())
//                 } else {
//                     Err("Failed to accept bidirectional stream".to_string())
//                 }
//             } else {
...
//     pub fn open_bidi_stream(&self) -> Result<(), String> {
//         let handle = self.runtime.handle();
...
//                     Ok(())
//                 } else {
//                     Err("Failed to open bidirectional stream".to_string())
//                 }
//             } else {
//                 Err("Not connected".to_string())
//             }
